...
public class DadosAdicionaisComunidadeDto {
    ...
    public DadosAdicionaisComunidadeDto() {
    ...
    public void setDataDiarioOficialUniaoDiarioOficialEstadoPortariaPeqTeq(Date dataDiarioOficialUniaoDiarioOficialEstadoPortariaPeqTeq) {
    ...
    public String getOutrosProcessosAdministrativos() {
        return outrosProcessosAdministrativos;
    }

    public void setOutrosProcessosAdministrativos(String outrosProcessosAdministrativos) {
