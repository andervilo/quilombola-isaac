const ModalAssentamentoList = {
        props: ['assentamentos', 'id'],
        data: function () {
            return {
            	data: this.assentamentos,
        ...
        methods:{
	    	      ...
	    	      .then(
	    	    		  response => {
			    	    	  if(response.status == 200){
			    	    		  ...
			    	    		  this.data = response.data.assentamentos
			    	    	  }
			    	      })
		    	     .catch(error => {
        	...
        	confirmCustomDelete(id) {
            	this.$buefy.dialog.confirm({
                    ...
                    onConfirm: () => {
                    	axios
              		  .delete(`/sigequi/api/v1/assentamentos/${id}`)
              		  .then(response =>{
        	...
        	saveDocumento(){
	    		...
	    		axios
	    	      .post("/sigequi/assentamentos/"+this.selected.id+"/documento", 
		                    ...
		                    >
			                    <template slot-scope="props">
				                    ...
				                    <b-table-column field="numero" label="Tipo">
				                        {{ props.row.tipo != null ? props.row.tipo.nome : "" }}
				                    </b-table-column>
				                    
				                    <b-table-column field="" label="">
				                    	<a :href="'/sigequi/assentamentos/'+props.row.id+'/documento'" style="color: #fff" 
