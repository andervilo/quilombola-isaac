const ModalMunicipio = {
        ...
        data: function () {
            return {
            	data: this.dataMunicipios.municipios,
        ...
        methods:{
			...
			desvincularMunicipio(idTerritorio, municipio) {
        		...
        		crudService.update(URL_BASE+"/comunidades/desvincular-comunidade", "", {municipioId: municipio.id, comunidadeId: idTerritorio}, r => {
					console.log(r)
        			 if(r.status==200){
	        ...
	        vincular(){
	        	...
	        	this.dataMunicipios.municipios.push({"id":this.selected.id})
	        	
	        	crudService.update(URL_BASE+"/comunidades/vincular-comunidade", "", {municipioId: this.selected.id, comunidadeId: this.dataMunicipios.id}, r => {
					console.log(r)
        			 if(r.status==200){
        			 	this.$buefy.toast.open({
                             duration: 3000,
	        ...
	        loadTerritorio(idTerritorio){
	        	...
	        	crudService.findById(URL, idTerritorio, r => {
	        		this.data =  _.sortBy(r.data.municipios, ['nome'])
        		})
	        },
            getMunicipios() {
    			this.municipios = []
	                ...
	                <div class="modal-card">
	                    ...
	                    <section class="modal-card-body"> 
					        ...
					        <div v-show="isVincularMunicipioActive">     
								        ...
								        <div>
	        								<button :disabled="selected.nome == null" class="button  is-info" type="button" @click="vincular"><i class="fas fa-save"></i>&nbsp;Salvar</button>
