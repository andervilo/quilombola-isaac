	        ...
	        methods:{
	        	getObjeto(){
	        		crudService.findById(URL_BASE+"/comunidades/", this.territorio.id, r => {
	        			if(r.data.editalComunicacao2 != null){
	        				this.isObjetoSetado = true
	        				this.object = r.data.editalComunicacao2	
                ...
                save(setado) {
		        	if(setado){
		        		...
		        		crudService.update(URL_BASE+"/comunidades/edital-comunicacao2", "", this.object, r => {
		        			console.log(r.data)
		        			if(r.status == 200){
	            		...
	            		this.object.comunidade = this.territorio.id
	            		crudService.create(URL_BASE+"/comunidades/edital-comunicacao2", this.object, r => {
	            			console.log(r.data)
	            			if(r.status == 200){
		        				this.$buefy.toast.open({
		                            duration: 3000,
