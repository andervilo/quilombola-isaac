const ModalPortariaReconhecimentoList = {
        props: ['data', 'id'],
        data: function () {
            return {
            	data: this.data,
        ...
        methods:{
	    	      ...
	    	      .then(
	    	    		  response => {
			    	    	  if(response.status == 200){
			    	    		  ...
			    	    		  this.data = response.data.portariasReconhecimento
			    	    	  }
			    	      })
		    	     .catch(error => {
        	...
        	confirmCustomDelete(id) {
            	this.$buefy.dialog.confirm({
                    ...
                    onConfirm: () => {
                    	axios
              		  .delete(`/sigequi/api/v1/portariasreconhecimentos/${id}`)
              		  .then(response =>{
        	...
        	saveDocumento(){
	    		...
	    		axios
	    	      .post("/sigequi/portarias/"+this.selected.id+"/documento", 
        ...
        mounted() {
            this.titulo="Portarias de Reconhecimento"
       	},
	    template: `<div>
	                <div class="modal-card">
	                    ...
	                    <section class="modal-card-body"> 
		                    <button class="button is-info is-small "
												...
												&nbsp;&nbsp;Adicionar Portaria de Reconhecimneto</button>
		                    <b-table
		                    ...
		                    >
			                    <template slot-scope="props">
				                    ...
				                    <b-table-column field="ambito.nome" label="Número Portaria">
				                        {{ props.row.numeroPortariaReconhecimento }}
				                    </b-table-column>
				                    ...
				                    <b-table-column field="" label="">
				                    	<a :href="'/sigequi/portarias/'+props.row.id+'/documento'" style="color: #fff" 
					...
					<b-modal can-cancel :active.sync="isNewActive" animation 
						...
						<modal-portaria-reconhecimento-add  
							:id="id"
							@buscar="buscar">>
						</modal-portaria-reconhecimento-add>
					</b-modal>
					...
					<b-modal can-cancel :active.sync="isEditActive" animation 
						:width="700" has-modal-card> 
						<modal-portaria-reconhecimento-edit  
							:id="id"
							:obj="selected"
							@buscar="buscar">
						</modal-portaria-reconhecimento-edit>
