const ModalCertificadosList = {
        ...
        methods:{
        	buscarCertificados(){
        		axios
      		  .get(`/sigequi/api/v1/comunidades/${this.id}`)
	    	      .then(
	    	    		  response => {
            ...
            confirmCustomDelete(id) {
            	this.$buefy.dialog.confirm({
                    ...
                    onConfirm: () => {
                    	axios
              		  .delete(`/sigequi/api/v1/certificados/${id}`)
              		  .then(response =>{
            ...
            editar(_selected){
                ...
                this.isCertificadoEditActive = true
            },
            ...
            saveDocumento(){
	    		...
	    		axios
	    	      .post("/sigequi/certificados/"+this.selected.id+"/documento", 
	    ...
	    template: `<div>
	                <div class="modal-card">
	                    ...
	                    <section class="modal-card-body"> 
					        ...
					        <button 
								...
								@click="isCertificadoNovoActive = true"><i class="fas fa-plus">
								</i>&nbsp;&nbsp;Adicionar Certificado
							</button>
		                    ...
		                    >
			                    <template slot-scope="props">
				                    ...
				                    <b-table-column field="numeroProcessoFcp" label="Número Processo FCP">
				                        {{ props.row.numeroProcessoFcp }}
				                    </b-table-column>
				                    
				                    <b-table-column field="" label="">
				                    	<a :href="'/sigequi/certificados/'+props.row.id+'/documento'" style="color: #fff" 
					...
					<b-modal can-cancel :active.sync="isCertificadoNovoActive" animation 
						...
						<modal-certificados-add  
							:id="id"
							@buscar-certificados="buscarCertificados">
						</modal-certificados-add>
					</b-modal>
					
					<b-modal can-cancel :active.sync="isCertificadoEditActive" animation 
						:width="700" has-modal-card> 
						<modal-certificados-edit  
							:id="id"
							:obj="selected"
							@buscar-certificados="buscarCertificados">
						</modal-certificados-edit>
