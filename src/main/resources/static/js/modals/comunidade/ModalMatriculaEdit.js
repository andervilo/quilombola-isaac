const ModalMatriculaEdit = {
	        ...
	        methods:{
	        	save(){
	        		...
	        		axios
	        		  .put(`/sigequi/api/v2/matriculas/${this.object.id}`, this.object)
		    	      .then(
		    	    		  response => {
	                ...
	                <div class="modal-card" >
	                    <header class="modal-card-head">
	                        <p class="modal-card-title">
		                    	<i class="icon-interface-windows" style="font-size: 30px;"></i> Editar Matrícula
