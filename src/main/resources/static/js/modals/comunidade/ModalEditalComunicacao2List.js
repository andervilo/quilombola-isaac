const ModalEditalComunicacao2List = {
        props: ['data', 'id'],
        data: function () {
            return {
            	data: this.data,
	    	      ...
	    	      .then(
	    	    		  response => {
			    	    	  if(response.status == 200){
			    	    		  ...
			    	    		  this.data = response.data.editaisComunicacao2
			    	    	  }
			    	      })
		    	     .catch(error => {
        ...
        mounted() {
            this.titulo="Edital Comunicação II"
       	},
	    template: `<div>
	                <div class="modal-card">
	                    ...
	                    <section class="modal-card-body"> 
		                    <button class="button is-info is-small "
												...
												&nbsp;&nbsp;Adicionar Edital Comunicação</button>
		                    <b-table
					...
					<b-modal can-cancel :active.sync="isNewActive" animation 
						...
						<modal-edital-comunicacao-2-add  
							:id="id"
							@buscar="buscar">>
						</modal-edital-comunicacao-2-add>
					</b-modal>
					...
					<b-modal can-cancel :active.sync="isEditActive" animation 
						:width="700" has-modal-card> 
						<modal-edital-comunicacao-2-edit  
							:id="id"
							:obj="selected"
							@buscar="buscar">
						</modal-edital-comunicacao-2-edit>
