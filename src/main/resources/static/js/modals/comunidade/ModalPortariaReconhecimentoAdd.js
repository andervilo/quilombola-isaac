const ModalPortariaReconhecimentoAdd = {
	        props: ['id'],
	        data:function(){
	        	return{
	        		object:{
	        ...
	        methods:{
	        	...
	        	save(){
	        		axios
	        		  .post(`/sigequi/api/v1/portariasreconhecimentos`, this.object)
		    	      .then(
		    	    		  response => {
	                ...
	                <div class="modal-card" >
	                    <header class="modal-card-head">
	                        <p class="modal-card-title">
		                    	<i class="icon-interface-windows" style="font-size: 30px;"></i> Adicionar Portaria de Reconhecimento
