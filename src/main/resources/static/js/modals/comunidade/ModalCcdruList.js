        ...
        methods:{
	    	      ...
	    	      .then(
	    	    		  response => {
			    	    	  if(response.status == 200){
			    	    		  ...
			    	    		  this.data = response.data.ccdrus
			    	    	  }
			    	      })
		    	     .catch(error => {
        	...
        	confirmCustomDelete(id) {
            	this.$buefy.dialog.confirm({
                    ...
                    onConfirm: () => {
                    	axios
              		  .delete(`/sigequi/api/v1/ccdrus/${id}`)
              		  .then(response =>{
	                    ...
	                    <section class="modal-card-body"> 
		                    ...
		                    >
			                    <template slot-scope="props">
				                    ...
				                    <b-table-column field="numeroPortaria" label="Número Portaria">
				                        {{ props.row.numeroPortaria }}
				                    </b-table-column>
				                    
							    	<b-table-column field="nomeImovel" label="Nome Imóvel">
							    	{{ props.row.nomeImovel }}
							    	</b-table-column>
