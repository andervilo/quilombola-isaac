...
$(document).ready(function () {
            ...
            datasets: [
                {
                    ...
                    pointRadius: 1,
                    pointHitRadius: 0,
                    data: [55, 20, 60, 31, 52, 22, 40, 25, 30, 68, 56, 40, 60, 43, 55, 39, 47],
                    spanGaps: false
                },
                {
                    label: "Page Views",
    ...
    var barChartHome = new Chart(BARCHARTHOME, {
        ...
        data: {
            labels: ["Jan", "February", "March", "April", "May", "June", "July", "August", "September", "November", "December"],
            datasets: [
                {
                    label: "Data Set 1",
                    backgroundColor: [
